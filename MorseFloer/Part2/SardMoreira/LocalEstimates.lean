...
import MorseFloer.Part2.SardMoreira.LebesgueDensity
import MorseFloer.Part2.SardMoreira.ContDiff
import MorseFloer.Part2.SardMoreira.ToMathlib.PR32186
...
theorem sub_isLittleO_norm_rpow_add_one_of_fderiv_of_density_point [FiniteDimensional ℝ E]
  ...
  replace hmeas : ∀ᶠ r in 𝓝[>] 0, μ (sᶜ ∩ closedBall a r) ≤ δ * μ (closedBall a r) := by
    ...
    rw [inter_comm, ← Set.sdiff_eq, ← ENNReal.add_le_add_iff_left this, measure_inter_add_sdiff _ hsm,
